...
public class AlertViewTestActivity extends Activity implements OnItemClickListener, OnDismissListener {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, AlertViewTestActivity.class);
//        starter.putExtra();
